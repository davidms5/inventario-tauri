...
// Crear usuario
#[tauri::command(rename_all = "snake_case")]
pub fn create_user(new_username: String, new_password_hash: String, new_rol: String) -> Result<usize, String> {
    let mut conn = db::get_conn();
...
//editar usuario
#[tauri::command(rename_all = "snake_case")]
pub fn update_user(target_id: i32, plain_password: String, new_rol: String) -> Result<usize, String> {
    let mut conn = db::get_conn();
